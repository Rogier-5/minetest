...
bool Database_Dummy::dbSaveBlock(const v3s16 &pos, const std::string &data)
{
	m_database[getBlockAsInteger(pos)] = data;
	return true;
}

void Database_Dummy::dbLoadBlock(const v3s16 &pos, std::string *block)
{
...
bool Database_Dummy::dbDeleteBlock(const v3s16 &pos)
{
